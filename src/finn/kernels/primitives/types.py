...
TilingSpec = Sequence[int | str | Any]
"""Stream/block tiling template: a per-dimension sequence of literals (1), tiling
parameter names ('SIMD', 'PE'), FULL_DIM sentinels, or derived-dim callables."""
