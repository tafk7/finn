...
(INV-L). This is the precondition for dropping the redundant kernel stamp (FU-1b): an
inferred node with no stamp still sweeps into a dataflow partition. Contract kept verbatim.
"""
