...
from finn.dataflow.space.branching import (
    BranchCatalog,
    BranchInfo,
    BranchOutputInfo,
    CaseInfo,
...
from finn.dataflow.space.spec_algebra import assemble_specs, combine_applicability, gate_spec
...
if TYPE_CHECKING:
    ...
    from finn.dataflow.space.occurrence import ProblemSource
...
def _occurrence_api() -> Any:
    ...
    from finn.dataflow.space.declarations import _occurrence_api as resolve  # noqa: PLC0415
