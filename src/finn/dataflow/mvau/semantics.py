...
from finn.dataflow.mvau.hardware.dotp_axi import covers_operand_types
...
from finn.dataflow.mvau_problem import MVAUComputationProfile, MVAUProblem, MVAUSourceDescription
