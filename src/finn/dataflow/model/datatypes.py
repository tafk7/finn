...
``finn.dataflow.space.dataflow_value_semantics``, built from the helpers here.
...
#: ``finn.dataflow.space.dataflow_value_semantics``, because the model layer must not import the
