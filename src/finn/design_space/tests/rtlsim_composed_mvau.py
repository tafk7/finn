...
Usage (from finn/):
    bash run-docker.sh bash src/finn/design_space/tests/run_rtlsim_composed.sh
"""
...
from finn.design_space.fixtures.parameters.names import DECOUPLED, RAM_STYLE, TOPOLOGY
