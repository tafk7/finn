...
from finn.design_space.fixtures.thresholding import (
    THRESHOLDING_HLS,
    THRESHOLDING_RTL,
    thresholding_schema,
)
...
def test_pool_is_hls_and_rtl(schema):
    from finn.design_space.fixtures.thresholding import thresholding_pool
...
def test_third_implementation_composes_additively():
    from finn.design_space.space import Derived, Implementation, pool_schema
    from finn.design_space.fixtures.thresholding import thresholding_pool, thresholding_shared
