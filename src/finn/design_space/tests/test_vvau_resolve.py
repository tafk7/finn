...
from finn.design_space.fixtures.vvau import VVAU_HLS, VVAU_RTL, vvau_schema
...
def test_pool_is_hls_and_single_rtl(schema):
    from finn.design_space.fixtures.vvau import vvau_pool
...
def test_third_implementation_composes_additively():
    ...
    from finn.design_space.fixtures.vvau import vvau_pool, vvau_shared
