...
from finn.design_space.space import AbsentAxisError, Context, Illegal, resolve
from finn.design_space.fixtures.parameters import (
    DECOUPLED,
    EMBEDDED,
    parameters_pool,
    parameters_schema,
...
def _mvau_ctx(part=VERSAL):
    ...
    from finn.design_space.space import Context as _C
...
def test_mvau_schema_carries_both_coordinates():
    ...
    from finn.design_space.fixtures.mvau import mvau_schema
