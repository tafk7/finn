...
from finn.design_space.space import Artifacts, Context, emit_point, resolve
from finn.design_space.fixtures.mvau import MVAU_HLS, mvau_schema
from finn.design_space.fixtures.parameters import DECOUPLED, parameters_pool
from finn.design_space.fixtures.parameters.emit_memstream import emit_memstream
...
def test_geometry_absent_for_embedded():
    from finn.design_space.fixtures.parameters import EMBEDDED
