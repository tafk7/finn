...
from finn.dataflow.model.design import configure_design
from finn.dataflow.model.dot_product_design import DESIGN_INPUTS, DotProductDesign
...
from finn.dataflow.ops.mvau.semantics import construct_decomposed_mvau_network
...
def test_the_design_calls_no_historical_region_or_network_constructor() -> None:
    path = Path(__file__).parents[3] / "src/finn/dataflow/model/dot_product_design.py"
