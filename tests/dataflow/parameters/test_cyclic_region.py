...
def test_delivery_exactly_preserves_standard_and_interleaved_weight_sequences() -> None:
    compute_regions = (
        construct_standard_streamed_mvau_region(2, 4, 4, INT8, INT8, INT16, 2, 2),
        construct_batch_interleaved_streamed_mvau_region(6, 4, 6, INT8, INT8, INT16, 3, 2, 3),
    )
    for compute in compute_regions:
