...
from finn.dataflow.space.declarations import enum_semantics
...
from finn.dataflow.space import Decision, Problem, Projection, Readiness, Space, derived
from finn.dataflow.space.compiler import _Ref
