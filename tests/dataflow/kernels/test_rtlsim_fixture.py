...
from dataflow.kernels.rtlsim.dotp_axi_numeric import CASES, CASES_BY_LABEL, DspBlock
from dataflow.kernels.rtlsim.dotp_axi_synth import DEFAULT_LABELS
from dataflow.kernels.rtlsim.replay_buffer_numeric import CASES as REPLAY_CASES
from dataflow.kernels.rtlsim.replay_buffer_numeric import CASES_BY_LABEL as REPLAY_BY_LABEL
from dataflow.kernels.rtlsim.replay_buffer_synth import DEFAULT_LABELS as REPLAY_SYNTH_LABELS
